...
#### **Tool 1: Split Intervals**

**Description:** Split Intervals
...
- class: DockerRequirement
  dockerPull: mutect2_strelka2:latest

```
---

#### **Tool 2: Convert Intervals to BED**

**Description:** Convert Intervals to BED
...
#### **Tool 4: Filter Mutect2 Results**

**Description:** Filter Mutect2 Results

```yaml
id: filter_mutect_tool
class: CommandLineTool
label: Filter Mutect2 Results
baseCommand:
- java
- -jar
- GATK4.jar
...
#### **Tool 5: Generate ANNOVAR AVInput**

**Description:** Generate ANNOVAR AVInput

```yaml
id: generate_annovar_avinput_tool
class: CommandLineTool
label: Generate ANNOVAR AVInput
baseCommand:
- zcat
inputs:
  vcf:
...
#### **Tool 6: Summarize Mutect2 Results**

**Description:** Summarize Mutect2 Results

```yaml
id: summarize_mutect_tool
class: CommandLineTool
label: Summarize Mutect2 Results
baseCommand:
- python
- summarize_script.py
inputs:
...
#### **Tool 8: Summarize Strelka2 Results**

**Description:** Summarize Strelka2 Results

```yaml
id: summarize_strelka_tool
class: CommandLineTool
label: Summarize Strelka2 Results
baseCommand:
- python
- summarize_strelka.py
inputs:
  vcf:
    type: File
    inputBinding:
